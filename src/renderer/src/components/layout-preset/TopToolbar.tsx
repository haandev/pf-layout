...
import { IconButton, Label, Separator, ToolbarItem, InlineSvg } from '../application-layout/elements';
...
const TopToolbar = React.memo(() => {
  ...
  return (
    <>
      ...
      <Separator />
      <ToolbarItem
        children={<IconButton onClick={() => app.flow?.zoomIn()} children={<InlineSvg source={zoomIn} />} />}
      />
      <ToolbarItem
        children={<IconButton onClick={() => app.flow?.zoomOut()} children={<InlineSvg source={zoomOut} />} />}
      />
      <ToolbarItem
        children={<IconButton onClick={() => app.flow?.fitView()} children={<InlineSvg source={zoom} />} />}
      />
    </>
  );
});
